...
function DropdownMenuTrigger({
  ...
  return (
    <DropdownMenuPrimitive.Trigger
      ...
      {...props}
      className="bg-[#1E201E] text-white hover:bg-[#1E201E]/80 hover:text-white/80 px-4 py-2 rounded-md"
    />
  );
}
...
function DropdownMenuItem({
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        "bg-[#1E201E] text-white hover:bg-[#1E201E]/80 hover:text-white/80",
...
function DropdownMenuCheckboxItem({
  ...
  return (
    <DropdownMenuPrimitive.CheckboxItem
      ...
      className={cn(
        "bg-[#1E201E] text-white hover:bg-[#1E201E]/80 hover:text-white/80",
        "relative flex cursor-default items-center gap-2 rounded-sm py-1.5 pr-2 pl-8 text-sm select-none outline-hidden",
        "data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
        className,
      )}
      checked={checked}
...
function DropdownMenuSeparator({
  ...
  return (
    <DropdownMenuPrimitive.Separator
      ...
      className={cn("bg-primary-color -mx-1 my-1 h-px", className)}
      {...props}
    />
  );
}
