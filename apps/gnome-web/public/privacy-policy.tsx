  ...
  return (
    <article>
      ...
      <p>
        ...
        <a href="https://krasnale.newbies.pl/privacy">Regulaminu Serwisu</a>,
      ...
      <ul>
        <li>
          <p>
            <strong>Serwis</strong> - serwis internetowy "Krasnal GO" działający
            pod adresem https://krasnale.newbies.pl
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            ...
            "ARASAKA Wiktor Petryszyn", o nadanym numerze identyfikacji
            podatkowej (NIP): 8952293060, świadcząca usługi drogą elektroniczną
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            pośrednictwem panelu użytkownika dostępnego po zalogowaniu i
            narzędzi umożliwiających dostęp do konta w przypadku zapomnianego
            hasła.W przypadku kont użytkowników, usunięcie danych polega na
            anonimizacji danych umożliwiających identyfikację Użytkownika.
            Administrator zastrzega sobie prawo wstrzymania realizacji żądania
            usunięcia danych w celu ochrony prawnie uzasadnionego interesu
