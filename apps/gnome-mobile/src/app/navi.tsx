    ...
    <View className="flex-1 justify-end">
      ...
      <View>
        <View className="flex-row border rounded-full bg-gray-700 border-gray-700 mt-4 mb-4 w-full  mx-auto">
          <Button className="bg-red-700 border rounded-full border-red-700 ml-4 mr-2 my-2"
          ...
          <Button className="bg-red-700 border rounded-full border-red-700 ml-2 mr-4 my-2"
          onPress={() => replace("/sign-in")}>
            <Text className="text-white font-Afacad">
              Galeria
            </Text>
